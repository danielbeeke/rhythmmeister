...
test('applyFontProperties should append font properties.', (t) => {
  ...
  t.is(
    rule.toString(),
    `div { 
        padding-top: 20px;line-height: 30px;color: blue;font-style: normal;font-size: 16px;font-weight: 400;font-family: 'Open Sans', serif; 
        color: red;
    }`
  )
})
...
test('fixPadding bottom and top', (t) => {
  ...
  t.is(
    ...
    `div { 
        border: 2px solid red;
        font-preset: paragraphs;padding-bottom: 4px;padding-top: 3px; 
        color: red;
    }`
  )
})
